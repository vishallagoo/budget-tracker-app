...
const MonthlyFigures = () => {
  const { projectedAmounts, monthlyData, setVisualizationArray } =
  ...
  return (
    <Box>
      ...
      <Typography color="text.primary" sx={{}}>
        Click on the pencil icon to set projected budget.
      </Typography>
      <Grid2 container spacing={2} sx={{ my: 2 }}>
        <Grid2 xs={12} sm={6} md={3}>
          <BudgetCards
            ...
            title="Income"
            textColor="#4CAF50"
            projected={projectedAmounts.projected_income}
            actual={totalIncome}
            img={SalaryImg}
          />
        </Grid2>
        <Grid2 xs={12} sm={6} md={3}>
          <BudgetCards
            type="projected_expense"
            title="Expense"
            textColor="#F44336"
            projected={projectedAmounts.projected_expense}
            actual={totalExpense}
            img={ExpenseImg}
          />
        </Grid2>
        <Grid2 xs={12} sm={6} md={3}>
          <BudgetCards
            type="projected_investments"
            title="Investments"
            textColor="#2196F3"
            projected={projectedAmounts.projected_investments}
        ...
        <Grid2 xs={12} sm={6} md={3}>
          <BudgetCards
            type="projected_balance"
            title="Balance"
            textColor="#009688"
            projected={projectedAmounts.projected_balance}
            actual={totalBalance}
            img={BalanceImg}
          />
        </Grid2>
